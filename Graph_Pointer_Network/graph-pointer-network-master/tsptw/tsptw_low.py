...
parser.add_argument('--epoch', default=5, help="number of epochs")
...
#if not os.path.isfile('./model/gpn_tsptw'+str(size)+'_low.pt'):
    #os.makedirs('./model/gpn_tsptw' + str(size) + '_low.pt')
save_root='./model/gpn_tsptw' + str(size) + '_low.pt'
...
np.save('./plot/val_mean_tsptw_low',val_mean_tsptw)
np.save('./plot/val_std_tsptw_low',val_std_tsptw)
